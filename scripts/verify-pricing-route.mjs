...
const files = {
  ...
  trialSection: resolve(root, 'app/components/sections/PricingTrialSection.vue'),
  formatsSection: resolve(root, 'app/components/sections/PricingFormatsSection.vue'),
  formatCard: resolve(root, 'app/components/pricing/PricingFormatCard.vue'),
  includedSection: resolve(root, 'app/components/sections/PricingIncludedSection.vue'),
  faqSection: resolve(root, 'app/components/sections/PricingFaqSection.vue'),
  faqItemComponent: resolve(root, 'app/components/pricing/PricingFaqItem.vue'),
  finalCtaSection: resolve(root, 'app/components/sections/PricingFinalCtaSection.vue'),
