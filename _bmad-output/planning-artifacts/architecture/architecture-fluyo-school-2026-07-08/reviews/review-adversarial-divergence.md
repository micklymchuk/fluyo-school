...
2. A proof-page builder puts production screenshots under public assets while a pricing builder enforces production status in content only.
...
No tracked high-severity divergence remains in the spine.
